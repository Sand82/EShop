        ...
        foreach (var order in orders) 
        {
            var orderDto = new OrderDto(
                ...
                ShippingAddress: new AddressDto(
                    order.ShippingAddress.FirsName,
                ...
                Status: order.Status,
                OrderItems: order.OrderItems.Select(oi => new OrderItemsDto(oi.OrderId.Value, oi.ProductId.Value, oi.Quantity, oi.Price)).ToList()
                );
