...
public static class OrderExtension
{
    ...
    {        
        return orders.Select(o => new OrderDto(
            ...
            BillingAddress: new AddressDto(o.BillingAddress.FirstName, o.BillingAddress.LastName, o.BillingAddress.EmailAddress!, o.BillingAddress.AddressLine, o.BillingAddress.Country, o.BillingAddress.State, o.BillingAddress.ZipCode),
